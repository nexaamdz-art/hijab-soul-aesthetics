...
- Very dark charcoal / almost black brown

- Subtle handmade paper texture

- Premium and slightly vintage appearance

- Height and proportions should closely match the reference image
...
- A simple elegant hijab/woman silhouette icon in an off-white color

- Text: "Hijab Soul"

- Under it, Arabic tagline:

  "أكثر من مجرد ملابس .. إنه أسلوب حياة"

- Small decorative heart elements
...
- Warm off-white / beige paper background

- Slightly irregular torn-paper edges
...
- Similar to #F4EBDD or a slightly warmer paper tone

- Very subtle paper grain/noise texture
...
- Main background: warm ivory cream
...
- Blue/purple modern SaaS styling
...
- Reproduce the reference composition closely.

- Header should span the entire screen.

- Search bar centered.

- Logo on the left.

- Account/wishlist/cart icons on the right.
...
- Replace the full navigation with a hamburger menu.

- Keep search, wishlist, account, and cart accessible.
...
- Search field should be functional.

- Wishlist icon should be clickable.

- Account icon should be clickable.

- Cart icon should be clickable.

- Hover states should be subtle and elegant.
