...
import { r as useAuth } from "./auth-context-B0JRZaal.mjs";
import { i as hijab_soul_mark_default } from "./store-data-Bmptt2jx.mjs";
import { g as Link, l as useLocation } from "../_libs/@tanstack/react-router_chunks.mjs";
import { B as Heart, D as MessageCircle, I as LayoutDashboard, O as Menu, V as Grid3x3, Y as ChevronDown, _ as Search, f as Sparkles, j as LogOut, m as ShieldCheck, n as X, o as Truck, p as ShoppingBag, q as CircleCheckBig, r as User, u as Tag, y as RefreshCw, z as House } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/SiteLayout-D0FhHcrH.js
...
function MobileBottomNav({ onOpenCategories }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "pointer-events-none absolute -top-4 inset-x-0 h-4 bg-gradient-to-t from-black/20 to-transparent" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("nav", {
			dir: "rtl",
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
					to: "/",
					className: `flex flex-col items-center justify-center gap-0.5 px-2 py-1 min-w-[56px] text-center transition-all ${isActive("/") && pathname === "/" ? "text-accent scale-105 font-bold" : "text-header-muted hover:text-white"}`,
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(House, {
						className: "h-5 w-5",
						strokeWidth: isActive("/") && pathname === "/" ? 2 : 1.5
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
					to: "/shop",
					className: `flex flex-col items-center justify-center gap-0.5 px-2 py-1 min-w-[56px] text-center transition-all ${isActive("/shop") ? "text-accent scale-105 font-bold" : "text-header-muted hover:text-white"}`,
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShoppingBag, {
						className: "h-5 w-5",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
					to: "/sales",
					className: `relative flex flex-col items-center justify-center gap-0.5 px-2 py-1 min-w-[56px] text-center transition-all ${isActive("/sales") ? "text-accent scale-105 font-bold" : "text-header-muted hover:text-white"}`,
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "relative",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Tag, {
							className: "h-5 w-5 text-burgundy animate-pulse",
							strokeWidth: 1.5
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "absolute -top-1 -right-1 flex h-2 w-2 rounded-full bg-red-500" })]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "text-[10px] leading-tight font-medium text-amber-200",
						children: "تخفيضات"
					})]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "relative flex items-center justify-center h-6 w-6 rounded-full bg-emerald-600/20 text-emerald-400",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					...
					onClick: () => {
						...
						else window.location.href = isAdmin ? "/admin" : "/shop";
					},
					className: "flex flex-col items-center justify-center gap-0.5 px-2 py-1 min-w-[56px] text-center text-header-muted hover:text-accent transition-all active:scale-95",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(User, {
						...
						className: "text-[10px] leading-tight font-medium truncate max-w-[50px]",
						children: user ? profile?.firstName || "حسابي" : "دخول"
					})]
				})
			]
		})]
...
function MobileCategoryChips() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "w-full bg-[#241B15] border-b border-[#3A2D23] py-2 px-3 lg:hidden overflow-x-auto scrollbar-none shadow-inner",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "flex items-center gap-2 min-w-max px-1",
			dir: "rtl",
			children: CHIPS.map((chip) => {
				const isActive = chip.to === "/shop" ? currentPath === "/shop" || currentPath === "/" : currentPath.startsWith(chip.to);
				return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
					to: chip.to,
					className: `relative flex items-center gap-1 px-3.5 py-1.5 rounded-full text-xs font-semibold transition-all whitespace-nowrap select-none active:scale-95 ${isActive ? "bg-[#FAF6F0] text-[#2B2119] shadow-md ring-1 ring-[#D5C2AA] font-bold" : "bg-[#2F231B] text-[#D0C0AF] hover:bg-[#3D2F24] hover:text-white"}`,
					children: [chip.badge && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
						className: "flex items-center gap-0.5 px-1 py-0.2 rounded-full bg-red-700 text-[9px] font-extrabold text-white leading-none",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sparkles, { className: "h-2.5 w-2.5" }), chip.badge]
...
function SiteLayout({ children }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "flex min-h-screen flex-col bg-background pb-16 lg:pb-0",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SiteHeader, { onMenuClick: () => setDrawerOpen(true) }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MobileCategoryChips, {}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MobileBottomNav, { onOpenCategories: () => setDrawerOpen(true) }),
