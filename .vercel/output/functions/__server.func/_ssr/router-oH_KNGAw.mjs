...
import { n as AuthProvider, r as useAuth } from "./auth-context-B5NfnVdI.mjs";
...
import { A as Mail, H as EyeOff, M as Lock, N as LoaderCircle, V as Eye, Y as CircleAlert, d as Sparkles, n as X, p as ShieldCheck, q as CircleCheck, r as User } from "../_libs/lucide-react.mjs";
import { t as QueryClient } from "../_libs/tanstack__query-core.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-oH_KNGAw.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-BU8vqVd5.css";
function AuthModal() {
	const { authModalOpen, authModalMode, prefilledEmail, closeAuthModal, openAuthModal, signInWithEmail, signUpWithEmail, signInWithGoogle } = useAuth();
	...
	}, [authModalOpen, prefilledEmail]);
	if (!authModalOpen) return null;
	const isSignUp = authModalMode === "signup";
	const handleGoogleSignIn = async (customEmail) => {
		setErrorMsg(null);
		setSuccessMsg(null);
		setIsLoading(true);
		try {
			const emailToUse = customEmail || (email.trim().includes("@") ? email.trim() : prefilledEmail || "nexa.am.dz@gmail.com");
			const res = await signInWithGoogle({
				email: emailToUse,
				fullName: isSignUp && (firstName || lastName) ? `${firstName} ${lastName}`.trim() : void 0
			});
			if (res.error) setErrorMsg(res.error.message || "تعذر تسجيل الدخول بحساب Google.");
			else {
				const isOwner = emailToUse.toLowerCase() === "nexa.am.dz@gmail.com";
				setSuccessMsg(isOwner ? "تم تسجيل الدخول بنجاح بحساب Google للمدير العام!" : "تم تسجيل الدخول بنجاح بحساب Google! مرحباً بكِ.");
				setTimeout(() => {
					closeAuthModal();
				}, 1e3);
			}
		...
		if (isSignUp) {
			...
			try {
				...
				if (error) setErrorMsg(error.message || "حدث خطأ أثناء إنشاء الحساب.");
					...
					const isOwner = cleanEmail.toLowerCase() === "nexa.am.dz@gmail.com";
					setSuccessMsg(isOwner ? "تم إنشاء حساب المدير العام بنجاح! مرحباً بكِ في لوحة التحكم والمتجر." : "تم إنشاء حسابكِ بنجاح! أهلاً وسهلاً بكِ في حجاب سول.");
					setTimeout(() => {
						closeAuthModal();
					}, 1200);
				}
			...
			try {
				...
				if (error) setErrorMsg(error.message || "بيانات الدخول غير صحيحة.");
					...
					const isOwner = cleanEmail.toLowerCase() === "nexa.am.dz@gmail.com";
					setSuccessMsg(isOwner ? "تم تسجيل الدخول بنجاح كمدير عام للمتجر!" : "تم تسجيل الدخول بنجاح! أهلاً بكِ مجدداً.");
					setTimeout(() => {
						closeAuthModal();
					}, 1e3);
				}
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: isSignUp ? "أنشئي حسابكِ بكلمة المرور الخاصة بكِ للوصول إلى الحساب أو الإدارة" : "أدخلي بريدكِ الإلكتروني وكلمة المرور لمتابعة التسوق أو الإدارة"
						})
					]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						...
						className: `flex-1 py-2 text-xs sm:text-sm font-bold rounded-lg transition-all cursor-pointer ${!isSignUp ? "bg-[#2B2119] text-white shadow-sm" : "text-[#5A412F] hover:text-[#2B2119]"}`,
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					...
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: isSignUp ? "التسجيل السريع بحساب Google" : "تسجيل الدخول بحساب Google" })]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
							...
							email.trim().toLowerCase() === "nexa.am.dz@gmail.com" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								className: "text-[11px] text-[#8C2A3E] font-bold mt-1 flex items-center gap-1",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldCheck, { className: "h-3.5 w-3.5" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "بريد الإدارة المعتمد (سيتم تفعيل صلاحيات المدير تلقائياً)" })]
							})
						] }),
						...
						isSignUp && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
							className: "block text-xs font-bold text-[#423124] mb-1",
...
var $$splitComponentImporter$12 = () => import("./routes-CwmhY7lT.mjs");
...
var $$splitComponentImporter$11 = () => import("./abayas-C9t_K3CB.mjs");
...
var $$splitComponentImporter$10 = () => import("./accessories-BjNzyPob.mjs");
...
var $$splitComponentImporter$9 = () => import("./admin-Bll-WRtL.mjs");
...
var $$splitComponentImporter$8 = () => import("./articles-BTuV_FZI.mjs");
...
var $$splitComponentImporter$7 = () => import("./dresses-TIzcKGIU.mjs");
...
var $$splitComponentImporter$6 = () => import("./hijab-robe-DWT5IxRw.mjs");
...
var $$splitComponentImporter$5 = () => import("./hijab-supplies-oErPaHUS.mjs");
...
var $$splitComponentImporter$4 = () => import("./isdalat-BcLX3yM9.mjs");
...
var $$splitComponentImporter$3 = () => import("./khimar-xLh9aN9g.mjs");
...
var $$splitComponentImporter$2 = () => import("./sales-DIbbU-4j.mjs");
...
var $$splitComponentImporter$1 = () => import("./shoes-CZ2GzoiW.mjs");
...
var $$splitComponentImporter = () => import("./shop-C1h31XRO.mjs");
