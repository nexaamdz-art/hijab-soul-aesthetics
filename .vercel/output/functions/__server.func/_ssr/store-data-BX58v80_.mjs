...
var INITIAL_PRODUCTS = [
	...
	},
	{
		...
		stock: 8,
		href: "/accessories",
		description: "حقيبة يد بيضاء مصممة بأسلوب باريسي كلاسيكي مزينة بوشاح حريري وتشارمز ذهبية راقية.",
		createdAt: "2026-09-19"
	},
	{
		id: "acc-3",
		...
		stock: 10,
		href: "/accessories",
		description: "حقيبة سهرة فنتج فاخرة بقماش حريري مطرز بأزهار رقيقة ومقبض لؤلؤي مع إبزيم دائري مرصع باللؤلؤ.",
		createdAt: "2026-09-19"
	},
	{
		id: "acc-4",
	...
	},
	{
		...
		stock: 20,
		href: "/accessories",
		description: "طوق شعر ناعم مصمم كغصن شجر ذهبي رقيق مرصع بزهور اللؤلؤ الأبيض النقي للمناسبات والأعراس.",
		createdAt: "2026-09-19"
	},
	{
		id: "acc-6",
		...
		stock: 25,
		href: "/accessories",
		description: "زوج مشابك شعر مفرغة بتصميم فراشة ملكية براقة مرصعة بأحجار الزركون والكريستال وحبيبات اللؤلؤ.",
		createdAt: "2026-09-19"
	},
	{
		id: "acc-7",
	...
	},
	{
		...
		stock: 14,
		href: "/accessories",
		description: "عقد ذهبي ساحر بتفاصيل أغصان الشجر المتشابكة مع زهور بلون اللافندر البنفسجي وقلادة وردة متلألئة.",
		createdAt: "2026-09-19"
	},
	{
		id: "acc-9",
		...
		stock: 22,
		href: "/accessories",
		description: "تشكيلة خواتم ذهبية رقيقة قابلة للتكديس مرصعة بأحجار ملونة وأشكال زهور وفراشات وقلوب ناعمة.",
		createdAt: "2026-09-19"
	},
	{
		id: "acc-10",
		...
		stock: 30,
		href: "/accessories",
		description: "سوار يدوي رقيق يجمع بين لآلئ ناعمة وزهور خرز كريستالي أزرق فاتح مع قفل ذهبي متين.",
		createdAt: "2026-09-19"
	},
	{
		id: "acc-11",
		...
		stock: 16,
		href: "/accessories",
		description: "سوار ذهبي كلاسيكي فاخر مستوحى من أغصان الزيتون ومرصع بأحجار زركون بيضاوية فائقة اللمعان.",
		createdAt: "2026-09-19"
	},
	{
		id: "acc-12",
	...
	},
	{
		...
		stock: 9,
		href: "/accessories",
		description: "طقم متكامل يضم 4 أساور فخمة: سوار جنزير، سوار مسمار مرصع، بنجل كلاسيكي، وسوار زهرة البرسيم الصدفية.",
		createdAt: "2026-09-19"
	},
	{
		id: "acc-14",
		...
		stock: 35,
		href: "/accessories",
		description: "معاصم وأكمام قماشية أنيقة ومحتشمة لستر الذراعين تحت العبايات والفساتين بتصاميم كشكش وفيونكات وأزرار.",
		createdAt: "2026-09-19"
	},
	{
		id: "abaya-1",
		...
		stock: 10,
		href: "/abayas",
		description: "عباءة سوداء فاخرة بقماش كريب كوري ملكي مزينة بقيطان زيتي ناعم وتطريز يدوي متقن لزهور وردية وبيضاء بأغصان مورقة على الصدر والأكمام الواسعة.",
		createdAt: "2026-09-19"
	},
	{
		id: "abaya-2",
		...
		stock: 6,
		href: "/abayas",
		description: "عباءة سهرة ومناسبات فخمة بقماش مخمل عنابي راقٍ، تتميز بتطريز فضي لامع مستوحى من أوراق الغار الملكية على الأكمام والجوانب بحواف مقوسة بديعة.",
		createdAt: "2026-09-19"
	},
	{
		id: "abaya-3",
		...
		stock: 8,
		href: "/abayas",
		description: "عباءة مفتوحة بقماش ملكي انسيابي تزدان بأغصان خرز يدوي ملون متدلية من الكتف بنعومة ولمعان خافت على أكمام الجرس الواسعة.",
		createdAt: "2026-09-19"
	},
	{
		id: "abaya-4",
		...
		stock: 7,
		href: "/abayas",
		description: "عباءة سهرة ساحرة مرصعة بخطوط كريستالية متلألئة تمتد بقطرية وانسيابية من الكتف حتى أسفل الفستان، تمنحك حضوراً ملكياً في أرقى المناسبات.",
		createdAt: "2026-09-19"
	},
	{
		id: "abaya-5",
		...
		stock: 12,
		href: "/abayas",
		description: "عباءة كيمونو مفتوحة بلون أخضر ساجي هادئ بقماش صيفي مريح، تتألق بأساور عريضة مرصعة بصفائح أحجار الكريستال اللامعة على المعصمين.",
		createdAt: "2026-09-19"
	},
	{
		id: "abaya-6",
		...
		stock: 5,
		href: "/abayas",
		description: "تصميم استثنائي من دار آدري بلون عنابي دافئ يجمع بين الأناقة والترف، مع أكمام دانتيل زهري عاجي وشراشيب حبات اللؤلؤ المتدلية.",
		createdAt: "2026-09-19"
	},
	{
		id: "abaya-7",
		...
		stock: 11,
		href: "/abayas",
		description: "عباءة مفتوحة كلاسيكية بلون عاجي فخم مزينة بطبعات زهور مائية فنية سوداء رمادية مستوحاة من اللوحات الكلاسيكية، مناسبة للزيارات والمناسبات النهارية.",
		createdAt: "2026-09-19"
	},
	{
		id: "abaya-8",
		...
		stock: 9,
		href: "/abayas",
		description: "طقم عباءة كاب فاخر بقصة أجنحة الفراشة الواسعة ولون بني شوكولاتة فخم مع فستان داخلي موكا وبروش ذهبي ملكي، إطلالة راقية تجمع بين الدفء والفخامة.",
		createdAt: "2026-09-19"
	},
	{
		id: "hijab-1",
		...
		stock: 25,
		href: "/hijab-supplies",
		description: "حجاب شيفون حريري فاخر بلون أسود داكن بتموجات مائية خافتة، مزود ببندانة مدمجة ودبابيس جانبية راقية لتثبيت أنيق ومحتشم طوال اليوم.",
		createdAt: "2026-09-19"
	},
	{
		id: "hijab-2",
		...
		stock: 18,
		href: "/hijab-supplies",
		description: "شالات شيفون فاخرة للمناسبات والسهرات متوفرة بألوان عاجي، كحلي داكن، وزيتي برونزي، تزدان بحواف مرصعة بخرزات لؤلؤ فضي لامع.",
		createdAt: "2026-09-19"
	},
	{
		id: "hijab-3",
		...
		stock: 15,
		href: "/hijab-supplies",
		description: "شال سهرة راقٍ بخامة كريب حرير ميتاليك رمادي فحمي لامع، يزدان بحلقات وأطواق خرزية ذهبية ناعمة على ثنية الرأس الأمامية.",
		createdAt: "2026-09-19"
	},
	{
		id: "hijab-4",
		...
		stock: 30,
		href: "/hijab-supplies",
		description: "حجاب تركي عملي وسريع اللبس بقماش كريب كوري ناعم لا يتطلب دبابيس، ينسدل بطبقات انسيابية تغطي الرأس والرقبة بارتياح تام.",
		createdAt: "2026-09-19"
	},
	{
		id: "hijab-5",
		...
		stock: 50,
		href: "/hijab-supplies",
		description: "مجموعة متكاملة من أجود خامات شيفون جورجيت الأصلي غير الشفاف، متوفرة بباقة ألوان ترابية وباستيل وملكية تناسب جميع إطلالاتك اليومية والمناسبات.",
		createdAt: "2026-09-19"
	},
	{
		id: "hijab-6",
		...
		stock: 22,
		href: "/hijab-supplies",
		description: "حجاب قطني جيرسي عالي الجودة والمرونة بخامة مودال تركية ناعمة وخفيفة، يثبت بسلاسة دون الحاجة لدبابيس بلون بوردو دافئ وجذاب.",
		createdAt: "2026-09-19"
	},
	{
		id: "isdal-2",
		...
		price: 4800,
		originalPrice: 5600,
		image: "/images/isdalat/pastel-blue-white.jpg",
		category: "isdalat",
		stock: 14,
		href: "/isdalat",
		description: "طقم إسدال راقٍ بلون أزرق سماوي باستيل هادئ مع خمار أبيض ناصع طويل ساتر ينسدل على الظهر والأكتاف برقة، قماش كريب ناعم وخفيف للصلاة والخروج.",
		createdAt: "2026-09-19"
	},
	{
		id: "isdal-3",
		...
		price: 5400,
		originalPrice: 6200,
		image: "/images/isdalat/layered-grey-black.jpg",
		category: "isdalat",
		stock: 16,
		href: "/isdalat",
		description: "تصميم مميز يجمع بين فستان إسدال أسود ملكي واسع بقصة أجنحة الفراشة وخمار رمادي مدبب ثلاثي الطبقات متدرج الأطراف، إطلالة محتشمة وغاية في الأناقة.",
		createdAt: "2026-09-19"
	},
	{
		id: "isdal-4",
		...
		price: 5200,
		originalPrice: 5900,
		image: "/images/isdalat/royal-blue-white.jpg",
		category: "isdalat",
		stock: 12,
		href: "/isdalat",
		description: "طقم صلاة وخروج مهيب بلون أزرق ملكي زاهٍ مع خمار شيفون كريب أبيض ناصع بثلاث طبقات متدرجة الزوايا، يوفر الراحة والستر التام.",
		createdAt: "2026-09-19"
	},
	{
		id: "isdal-5",
		...
		price: 4900,
		originalPrice: 5700,
		image: "/images/isdalat/chocolate-black-isdal.jpg",
		category: "isdalat",
		stock: 15,
		href: "/isdalat",
		description: "طقم جلباب وإسدال متكامل بخامة كريب ملكي بلون بني شوكولاتة دافئ بأكمام مزمومة مريحة، مع خمار أسود طويل منسدل ساتر للصدر والظهر.",
		createdAt: "2026-09-19"
	},
	{
		id: "isdal-6",
		...
		price: 4600,
		originalPrice: 5300,
		image: "/images/isdalat/tiered-chocolate-isdal.jpg",
		category: "isdalat",
		stock: 18,
		href: "/isdalat",
		description: "خمار وإسدال فريد بطبقات شيفون جورجيت متتالية بلون شوكولاتة عميق مع أطراف كشكش ناعمة تمنح حجماً وانسيابية ساحرة فوق الفساتين والعبايات.",
		createdAt: "2026-09-19"
	},
	{
		id: "dress-linen-grey",
		...
		price: 4600,
		originalPrice: 5200,
		image: "/images/dresses/grey_linen.jpg",
		category: "dresses",
		stock: 14,
		href: "/dresses",
		description: "فستان كتان طبيعي فاخر بلون رمادي فاتح مريح، بياقة دائرية أنيقة وزمزمة ناعمة أسفل الصدر وأكمام بوف واسعة مع مطاط معصم مرن للإطلالات اليومية والعملية.",
		createdAt: "2026-09-19"
	},
	{
		...
		price: 4900,
		originalPrice: 5600,
		image: "/images/dresses/floral_chiffon.jpg",
		category: "dresses",
		stock: 16,
		href: "/dresses",
		description: "فستان صيفي رقيق ومحتشم بخامة شيفون حريري بارد مع بطانة ناعمة، منقوش بزهور بنفسجية لافندر أنثوية مع ياقة عالية وخصر مطاطي مريح وأكمام واسعة.",
		createdAt: "2026-09-19"
	},
	{
		...
		price: 5500,
		originalPrice: 6400,
		image: "/images/dresses/vintage_green.jpg",
		category: "dresses",
		stock: 11,
		href: "/dresses",
		description: "تصميم كلاسيكي راقٍ بلون أخضر زيتي ملكي بياقة مرتفعة وكسرات بليسيه متوازية على الخصر، مع تفاصيل أكمام دانتيل فرنسي أبيض مفرغ مع فيونكة رقيقة.",
		createdAt: "2026-09-19"
	},
	{
		...
		price: 4700,
		originalPrice: 5300,
		image: "/images/dresses/mauve_crepe.jpg",
		category: "dresses",
		stock: 18,
		href: "/dresses",
		description: "فستان كريب تركي انسيابي بلون وردي موف كشميري دافئ، يتميز برباطين جانبيين لضبط المقاس والخصر حسب الرغبة وأكمام واسعة أنيقة لراحة يومية محتشمة.",
		createdAt: "2026-09-19"
	},
	{
		...
		price: 6800,
		originalPrice: 7800,
		image: "/images/dresses/chocolate_cape.jpg",
		category: "dresses",
		stock: 9,
		href: "/dresses",
		description: "فستان سهرة مهيب بلون بني شوكولاتة غني، مزود بكاب ملكي ممتد على الظهر والأكتاف مع ثنيات وكسرات عمودية طويلة وحزام نحيف يبرز جمال التصميم المحتشم.",
		createdAt: "2026-09-19"
	},
	{
		...
		price: 7200,
		originalPrice: 8400,
		image: "/images/dresses/blush_couture.jpg",
		category: "dresses",
		stock: 8,
		href: "/dresses",
		description: "قطعة كوتور فاخرة للمناسبات الكبرى بلون وردي بودري ناعم، مرصع بتطريز زهور مجسمة وخرز ولؤلؤ على الخصر، مع أكمام جرس شيفون واسعة ووشاح كاب متدفق.",
		createdAt: "2026-09-19"
	},
	{
		...
		price: 5100,
		originalPrice: 5900,
		image: "/images/dresses/burgundy_tiered.jpg",
		category: "dresses",
		stock: 15,
		href: "/dresses",
		description: "فستان ماكسي فضفاض محتشم بلون عنابي بوردو ملكي دافئ، بطبقات كشكش سفلية واسعة وأكمام بوف منسدلة وحزام خصر قماشي ناعم، رائع للنزهات والزيارات.",
		createdAt: "2026-09-19"
	},
	{
		...
		price: 5800,
		originalPrice: 6600,
		image: "/images/dresses/lavender_vintage.jpg",
		category: "dresses",
		stock: 10,
		href: "/dresses",
		description: "فستان استثنائي بلون بنفسجي لافندر فاتح مع تفاصيل رباط كورسيه جانبي كلاسيكي وشرائط منسدلة، بأكمام بوف درامية واسعة تمنح حضوراً سينمائياً ساحراً.",
		createdAt: "2026-09-19"
	},
	{
		...
		price: 7900,
		originalPrice: 9200,
		image: "/images/dresses/white_cape_bridal.jpg",
		category: "dresses",
		stock: 7,
		href: "/dresses",
		description: "تصميم عرائسي ومناسبات مهيب بقماش كريب وحرير أبيض ناصع مع كاب ملكي ينسدل فوق الأكتاف والظهر وياقة عالية ساترة وأكمام بوف مزمومة بكشكش ناعم.",
		createdAt: "2026-09-19"
	},
	{
		...
		price: 6900,
		originalPrice: 7900,
		image: "/images/dresses/lilac_evening_set.jpg",
		category: "dresses",
		stock: 9,
		href: "/dresses",
		description: "إطلالة سهرة متكاملة راقية بفستان كريب استرتش ليلكي بخصر درابيه وأكمام كاب واسعة، منسق مع شال شيفون ليلكي متناغم وحقيبة كلتش لؤلؤية فاخرة.",
		createdAt: "2026-09-19"
	},
	{
		...
		price: 4800,
		originalPrice: 5500,
		image: "/images/dresses/chocolate_bell_sleeve.jpg",
		category: "dresses",
		stock: 17,
		href: "/dresses",
		description: "فستان كريب أنيق وعملي بلون بني شوكولاتة سادة بقصة مينيمال مستقيمة، يتميز بأكمام مروحية واسعة وحزام خصر خلفي أنيق يضفي لمسة رقي وانسيابية عصرية.",
		createdAt: "2026-09-19"
	},
	{
		...
		price: 5300,
		originalPrice: 6100,
		image: "/images/dresses/sage_tiered_set.jpg",
		category: "dresses",
		stock: 13,
		href: "/dresses",
		description: "فستان أخضر مريمي / زيتي فاتح كاجوال بياقة عالية وأزرار صدر كلاسيكية وقصة طبقات كشكش واسعة، منسق بإتقان مع شال بيج نيود وحقيبة جلدية ناعمة.",
		createdAt: "2026-09-19"
	}
];
var INITIAL_ORDERS = [
...
var PRODUCTS_KEY = "hijab_soul_products_v6";
var ORDERS_KEY = "hijab_soul_orders_v1";
var CONVERSATIONS_KEY = "hijab_soul_conversations_v1";
var CATEGORIES_KEY = "hijab_soul_categories_v3";
var HERO_BANNER_KEY = "hijab_soul_hero_banner_v1";
var INITIAL_CATEGORIES = [
	{
		...
		bannerImage: "/images/dresses/chocolate_cape.jpg",
	...
	},
	{
		...
		bannerImage: "/images/isdalat/pastel-blue-white.jpg",
	...
	},
	{
		...
		bannerImage: "/images/products/product-1.jpg",
...
var CURATED_IMAGE_PRESETS = [
	...
	},
	{
		...
		category: "dresses",
		url: "/images/dresses/grey_linen.jpg"
	},
	{
		id: "p-dr-2",
		name: "فستان شيفون مورد",
		category: "dresses",
		url: "/images/dresses/floral_chiffon.jpg"
	},
	{
		id: "p-dr-3",
		name: "فستان فينتج زيتي",
		category: "dresses",
		url: "/images/dresses/vintage_green.jpg"
	},
	{
		id: "p-dr-4",
		name: "فستان كريب موف ناعم",
		category: "dresses",
		url: "/images/dresses/mauve_crepe.jpg"
	},
	{
		id: "p-dr-5",
		name: "كاب شوكولاتة كلاسيكي",
		category: "dresses",
		url: "/images/dresses/chocolate_cape.jpg"
	},
	{
		id: "p-dr-6",
		name: "فستان كوتور وردي بلش",
		category: "dresses",
		url: "/images/dresses/blush_couture.jpg"
	},
	{
		id: "p-dr-7",
		name: "فستان طبقات عنابي",
		category: "dresses",
		url: "/images/dresses/burgundy_tiered.jpg"
	},
	{
		id: "p-dr-8",
		name: "فستان لافندر فينتج",
		category: "dresses",
		url: "/images/dresses/lavender_vintage.jpg"
	},
	{
		id: "p-dr-9",
		name: "كاب أبيض عرائسي",
		category: "dresses",
		url: "/images/dresses/white_cape_bridal.jpg"
	},
	{
		id: "p-dr-10",
		name: "طقم سهرة ليلكي",
		category: "dresses",
		url: "/images/dresses/lilac_evening_set.jpg"
	},
	{
		id: "p-ab-1",
	...
	},
	{
		...
		category: "isdalat",
		url: "/images/isdalat/pastel-blue-white.jpg"
	},
	{
		id: "p-is-2",
		name: "إسدال طبقات رمادي وأسود",
		category: "isdalat",
		url: "/images/isdalat/layered-grey-black.jpg"
	},
	{
		id: "p-is-3",
		name: "إسدال ملكي أزرق وأبيض",
		category: "isdalat",
		url: "/images/isdalat/royal-blue-white.jpg"
	},
	{
		id: "p-is-4",
		name: "إسدال شوكولاتة وأسود",
		category: "isdalat",
		url: "/images/isdalat/chocolate-black-isdal.jpg"
	},
	{
		id: "p-is-5",
		name: "إسدال متدرج كشكش شوكولاتة",
		category: "isdalat",
		url: "/images/isdalat/tiered-chocolate-isdal.jpg"
	},
	{
		id: "p-ac-1",
...
*/
function compressImageFile(file, maxWidth = 1e3, quality = .85) {
...
function getStoredCategories() {
	...
	try {
		...
		let hasNew = false;
		for (const initCat of INITIAL_CATEGORIES) if (!existingIds.has(initCat.id)) {
			parsed.push(initCat);
			hasNew = true;
		}
		if (hasNew) localStorage.setItem(CATEGORIES_KEY, JSON.stringify(parsed));
...
function saveStoredHeroBanner(url) {
	if (typeof window === "undefined") return;
	if (url) localStorage.setItem(HERO_BANNER_KEY, url);
...
function getStoredProducts() {
	...
	try {
		...
		let hasNew = false;
		for (const initProd of INITIAL_PRODUCTS) if (!existingIds.has(initProd.id)) {
			parsed.push(initProd);
			hasNew = true;
		}
		if (hasNew) localStorage.setItem(PRODUCTS_KEY, JSON.stringify(parsed));
		return parsed;
	} catch {
		return INITIAL_PRODUCTS;
	}
...
function useStoreData() {
	const [products, setProducts] = (0, import_react.useState)(() => getStoredProducts());
	const [orders, setOrders] = (0, import_react.useState)(() => getStoredOrders());
	const [conversations, setConversations] = (0, import_react.useState)(() => getStoredConversations());
	const [categories, setCategories] = (0, import_react.useState)(() => getStoredCategories());
	const [heroBanner, setHeroBanner] = (0, import_react.useState)(() => getStoredHeroBanner());
	...
	const updateCategory = (0, import_react.useCallback)((id, updates) => {
		setCategories((prev) => {
			const next = prev.map((cat) => cat.id === id ? {
				...cat,
				...updates
			} : cat);
	...
	const addCategory = (0, import_react.useCallback)((newCat) => {
	...
	const deleteCategory = (0, import_react.useCallback)((id) => {
		setCategories((prev) => {
	...
	const resetCategoriesToDefault = (0, import_react.useCallback)(() => {
		setCategories(INITIAL_CATEGORIES);
		saveStoredCategories(INITIAL_CATEGORIES);
	}, []);
	const updateHeroBanner = (0, import_react.useCallback)((url) => {
		setHeroBanner(url);
	...
	return {
		...
		categories,
		heroBanner,
		updateProduct: (0, import_react.useCallback)((updated) => {
			setProducts((prev) => {
		...
		addProduct: (0, import_react.useCallback)((newProd) => {
			const item = {
				...newProd,
				id: `product-${Date.now()}`,
		...
		deleteProduct: (0, import_react.useCallback)((id) => {
			setProducts((prev) => {
		...
		updateOrderStatus: (0, import_react.useCallback)((orderId, status) => {
			setOrders((prev) => {
				const next = prev.map((ord) => ord.id === orderId ? {
					...ord,
					status
				} : ord);
		...
		deleteOrder: (0, import_react.useCallback)((orderId) => {
			setOrders((prev) => {
		...
		sendMessage: (0, import_react.useCallback)((conversationId, text, sender = "admin") => {
			const newMessage = {
				id: `msg-${Date.now()}`,
				conversationId,
				sender,
				text,
				timestamp: (/* @__PURE__ */ new Date()).toLocaleTimeString("ar-DZ", {
					hour: "2-digit",
					minute: "2-digit"
				}),
				isRead: sender === "admin"
		...
		markConversationAsRead: (0, import_react.useCallback)((conversationId) => {
			setConversations((prev) => {
				const next = prev.map((c) => {
					if (c.id === conversationId) return {
						...c,
...
//#endregion
export { useStoreData as i, compressImageFile as n, hijab_soul_mark_default as r, CURATED_IMAGE_PRESETS as t };
