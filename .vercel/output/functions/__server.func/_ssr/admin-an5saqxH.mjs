...
import { r as useAuth, t as ADMIN_EMAILS } from "./auth-context-D3gqmc4C.mjs";
import { h as Link } from "../_libs/@tanstack/react-router_chunks.mjs";
import { $ as Check, A as Mail, C as Package, E as MessageCircle, F as LayoutGrid, G as Download, H as Eye, I as LayoutDashboard, J as CircleX, K as Crown, L as Layers, M as Lock, N as LoaderCircle, O as Maximize2, P as Link$1, Q as ChevronDown, R as KeyRound, S as Pen, T as MessageSquare, U as EyeOff, V as FileText, W as ExternalLink, Y as CircleCheck, Z as CircleAlert, _ as RotateCcw, a as Upload, b as Plus, c as TrendingUp, d as Sparkles, et as CheckCheck, f as ShoppingBag, g as Search, h as Send, i as UserCheck, k as MapPin, l as Trash2, m as Settings, n as X, nt as ArrowUpRight, o as Truck, p as ShieldCheck, q as Clock, r as User, rt as ArrowRight, s as TriangleAlert, t as Zap, tt as Camera, u as Store, x as Phone, y as Printer, z as Image } from "../_libs/lucide-react.mjs";
import { i as useStoreData, n as compressImageFile, r as getProductFallbackImage, t as CURATED_IMAGE_PRESETS } from "./store-data-DmVY4QsC.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/admin-an5saqxH.js
...
function AdminSettings() {
	...
	const [adminEmail, setAdminEmail] = (0, import_react.useState)(ADMIN_EMAILS[0] || "admin@hijabsoul.dz");
	...
	const [newAdminPassword, setNewAdminPassword] = (0, import_react.useState)("");
	const [confirmAdminPassword, setConfirmAdminPassword] = (0, import_react.useState)("");
	const [passwordToast, setPasswordToast] = (0, import_react.useState)(null);
	...
	const handleUpdatePassword = async (e) => {
		...
		try {
			...
			if (!res.ok) setPasswordError(data.error || "فشل تحديث كلمة المرور.");
			else {
				setPasswordToast("تم تحديث كلمة مرور المدير بنجاح!");
				setCurrentPassword("");
				setNewAdminPassword("");
				setConfirmAdminPassword("");
				setTimeout(() => setPasswordToast(null), 3e3);
			}
		} catch {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Lock, { className: "h-3.5 w-3.5 text-[#8C2A3E]" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "حالة الحماية والأمان:" })]
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "text-xs text-[#5A412F]",
										children: "لا يمكن لأي مستخدم الوصول إلى لوحة الإدارة إلا بعد التحقق الصارم من كلمة المرور السرية."
									})]
								})]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "pt-4 border-t border-[#E3D4C0] mt-4",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h4", {
										className: "text-xs font-bold text-[#2B2119] flex items-center gap-1.5 mb-2",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(KeyRound, { className: "h-3.5 w-3.5 text-[#8C2A3E]" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "تغيير كلمة المرور السرية للمدير" })]
									}),
									passwordError && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "mb-3 flex items-start gap-1.5 rounded-xl bg-red-50 border border-red-200 p-2.5 text-xs text-red-800",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleAlert, { className: "h-3.5 w-3.5 text-red-600 shrink-0 mt-0.5" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: passwordError })]
									}),
									passwordToast && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "mb-3 flex items-start gap-1.5 rounded-xl bg-emerald-50 border border-emerald-200 p-2.5 text-xs text-emerald-800",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Check, { className: "h-3.5 w-3.5 text-emerald-600 shrink-0 mt-0.5" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: passwordToast })]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "grid grid-cols-1 sm:grid-cols-3 gap-3",
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
												className: "block text-[11px] font-semibold text-[#423124] mb-1",
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										...
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
											...
											children: isChangingPass ? "جاري التحديث..." : "تحديث كلمة المرور"
										})
									})
								]
							})
...
function AdminPage() {
	...
	const [adminEmail, setAdminEmail] = (0, import_react.useState)("nexa.am.dz@gmail.com");
	...
	const handleAdminLoginSubmit = async (e) => {
		...
		try {
			...
			if (res.error) setLoginError(res.error.message || "بيانات الدخول غير صحيحة.");
		} catch {
	...
	if (!isAdmin) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "min-h-[85vh] flex items-center justify-center p-4 bg-[#FAF6F0]",
		dir: "rtl",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "w-full max-w-md rounded-3xl bg-white p-7 sm:p-8 shadow-xl border border-[#E3D4C0] text-center space-y-5",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-[#2B2119] text-[#FAF6F0] shadow-md",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Lock, { className: "h-8 w-8 text-amber-300" })
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-amber-50 border border-amber-200 text-amber-900 text-xs font-bold mb-2",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldCheck, { className: "h-3.5 w-3.5 text-amber-600" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "بوابة الإدارة المحمية" })]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
						className: "text-2xl font-black text-[#2B2119]",
						children: "تسجيل دخول مدير المتجر"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-xs sm:text-sm text-[#735A45] mt-1.5 leading-relaxed",
						children: "هذه المنطقة مخصصة لإدارة المتجر وتتطلب إدخال كلمة المرور السرية للمدير العام."
					})
				] }),
				loginError && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-start gap-2 rounded-xl bg-red-50 border border-red-200 p-3 text-xs text-red-800 text-right leading-snug",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleAlert, { className: "h-4 w-4 text-red-600 shrink-0 mt-0.5" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: loginError })]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
							className: "block text-xs font-bold text-[#423124] mb-1",
							children: ["بريد الإدارة المعتمد ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "text-[#8C2A3E]",
								children: "*"
							})]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
								className: "block text-xs font-bold text-[#423124]",
								children: ["كلمة المرور السرية ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "text-[#8C2A3E]",
									children: "*"
								})]
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							...
							children: isSubmitting ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, { className: "h-4 w-4 animate-spin" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "جاري التحقق من كلمة المرور..." })] }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldCheck, { className: "h-4 w-4 text-amber-300" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "دخول لوحة التحكم" })] })
						})
					]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "pt-2 border-t border-[#E3D4C0]/60",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowRight, { className: "h-3.5 w-3.5" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "العودة للمتجر الرئيسي" })]
					})
				})
			]
		})
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "min-h-screen bg-[#F7F3ED] text-[#2B2119]",
		dir: "rtl",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
			className: "sticky top-0 z-30 bg-[#2B2119] text-[#FAF6F0] border-b border-[#3D2F24] shadow-md",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center gap-3",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "flex h-9 w-9 items-center justify-center rounded-xl bg-[#FAF6F0]/10 text-amber-300",
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							...
							className: "px-2 py-0.5 rounded-full bg-amber-400/20 text-amber-300 text-[10px] font-bold border border-amber-400/30",
							children: "لوحة الإدارة"
						})]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						className: "text-[11px] text-[#D5C2AA]/80 hidden sm:block",
						children: [
							"مرحباً ",
							profile?.fullName || "بالمدير العام",
							" — ",
							user?.email
						]
					})] })]
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ExternalLink, { className: "h-3.5 w-3.5" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "معاينة المتجر" })]
					})
				})]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 overflow-x-auto scrollbar-none flex gap-1 sm:gap-2 pb-2",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						type: "button",
						onClick: () => setActiveTab("overview"),
						className: `flex items-center gap-2 px-3.5 py-2 rounded-xl text-xs sm:text-sm font-bold transition-all shrink-0 cursor-pointer ${activeTab === "overview" ? "bg-[#FAF6F0] text-[#2B2119] shadow-xs" : "text-[#D5C2AA] hover:bg-white/10 hover:text-white"}`,
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(LayoutDashboard, { className: "h-4 w-4" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "نظرة عامة" })]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						type: "button",
						onClick: () => setActiveTab("orders"),
						className: `flex items-center gap-2 px-3.5 py-2 rounded-xl text-xs sm:text-sm font-bold transition-all shrink-0 cursor-pointer ${activeTab === "orders" ? "bg-[#FAF6F0] text-[#2B2119] shadow-xs" : "text-[#D5C2AA] hover:bg-white/10 hover:text-white"}`,
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShoppingBag, { className: "h-4 w-4" }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "الطلبات" }),
							pendingOrdersCount > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "px-1.5 py-0.2 rounded-full bg-[#8C2A3E] text-white text-[10px] font-bold",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						className: `flex items-center gap-2 px-3.5 py-2 rounded-xl text-xs sm:text-sm font-bold transition-all shrink-0 cursor-pointer ${activeTab === "products" ? "bg-[#FAF6F0] text-[#2B2119] shadow-xs" : "text-[#D5C2AA] hover:bg-white/10 hover:text-white"}`,
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						className: `flex items-center gap-2 px-3.5 py-2 rounded-xl text-xs sm:text-sm font-bold transition-all shrink-0 cursor-pointer ${activeTab === "categories" ? "bg-[#FAF6F0] text-[#2B2119] shadow-xs" : "text-[#D5C2AA] hover:bg-white/10 hover:text-white"}`,
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						className: `flex items-center gap-2 px-3.5 py-2 rounded-xl text-xs sm:text-sm font-bold transition-all shrink-0 cursor-pointer ${activeTab === "chat" ? "bg-[#FAF6F0] text-[#2B2119] shadow-xs" : "text-[#D5C2AA] hover:bg-white/10 hover:text-white"}`,
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MessageSquare, { className: "h-4 w-4" }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "المحادثات" }),
							unreadMessagesCount > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "px-1.5 py-0.2 rounded-full bg-emerald-500 text-white text-[10px] font-bold",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						className: `flex items-center gap-2 px-3.5 py-2 rounded-xl text-xs sm:text-sm font-bold transition-all shrink-0 cursor-pointer ${activeTab === "settings" ? "bg-[#FAF6F0] text-[#2B2119] shadow-xs" : "text-[#D5C2AA] hover:bg-white/10 hover:text-white"}`,
