...
import { n as AuthProvider, r as useAuth } from "./auth-context-DORCMZz9.mjs";
...
import { A as Mail, H as Eye, J as CircleCheck, M as Lock, N as LoaderCircle, R as KeyRound, U as EyeOff, X as CircleAlert, d as Sparkles, n as X, nt as ArrowRight, p as ShieldCheck, r as User, v as RefreshCw } from "../_libs/lucide-react.mjs";
import { t as QueryClient } from "../_libs/tanstack__query-core.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-C76_O6c0.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-CT7BSwWb.css";
function AuthModal() {
	const { authModalOpen, authModalMode, prefilledEmail, closeAuthModal, openAuthModal, signInWithEmail, signUpWithEmail, verifySignUpOtp, signInWithGoogle, signInQuickAdmin, sendPasswordResetOtp, verifyPasswordResetOtpAndUpdate } = useAuth();
	const [currentView, setCurrentView] = (0, import_react.useState)("signin");
	const [googleSetupGuide, setGoogleSetupGuide] = (0, import_react.useState)(false);
			...
			try {
				...
				if (!probe.ok) {
					...
					if (body?.msg?.includes("provider is not enabled") || body?.error_code === "validation_failed") {
						...
						setErrorMsg("تنبيه: موفر Google غير مفعّل بعد في لوحة تحكم Supabase لمشروعك (xiytavyvffzaxxygctbs). يرجى تفعيله في لوحة Supabase للربط المباشر.");
						setIsLoading(false);
						return;
					}
				}
	...
	const handleSignUpSubmit = async (e) => {
		...
		try {
			...
			if (result.error) setErrorMsg(result.error.message || "حدث خطأ أثناء إرسال بريد التفعيل.");
				...
				setSuccessMsg(`📧 تم إرسال رسالة التأكيد إلى بريدك الإلكتروني (${cleanEmail}). إذا وصلكِ رابط تأكيد، اضغطي عليه لتأكيد الحساب مباشرة، أو أدخلي الرمز إذا كان رمزاً رقمياً.`);
			}
		} catch (err) {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				(currentView === "signin" || currentView === "signup") && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
					...
					googleSetupGuide && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "mb-3.5 rounded-xl border border-amber-300 bg-amber-50/90 p-3.5 text-xs text-amber-950 space-y-2 animate-in fade-in duration-200",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex items-center gap-1.5 font-bold text-amber-900",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleAlert, { className: "h-4 w-4 text-amber-700 shrink-0" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "تنبيه: يلزم تفعيل موفر Google في لوحة تحكم Supabase" })]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("code", {
										className: "bg-amber-100 px-1 py-0.5 rounded font-mono text-[10px]",
										children: "xiytavyvffzaxxygctbs"
									}),
									") يحتاج إلى تفعيل موفر Google يدوياً:"
								]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ol", {
								className: "list-decimal list-inside text-[11px] space-y-1 text-amber-900 font-medium",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: [
										"افتحي لوحة ",
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "Supabase" }),
										" > ",
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "Authentication" }),
										" >",
										" ",
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "Providers" }),
										" > ",
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "Google" }),
										"."
									] }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "قومي بتفعيل المفتاح (Enable Google provider)." }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: [
										"أضيفي ",
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "Client ID" }),
										" و ",
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "Client Secret" }),
										" من Google Cloud Console."
									] }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: ["رابط إعادة التوجيه (Callback URL) المطلوب:", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "mt-1 p-1.5 bg-white/80 rounded border border-amber-200 font-mono text-[10px] select-all break-all text-left",
										dir: "ltr",
										children: "https://xiytavyvffzaxxygctbs.supabase.co/auth/v1/callback"
									})] })
								]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "pt-2 border-t border-amber-200/60 flex items-center justify-between gap-2",
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldCheck, { className: "h-3.5 w-3.5 text-amber-300" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "دخول فوري مباشر (Admin Login للتجربة)" })]
								})
							})
						]
					}),
				...
				currentView === "verify-otp" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "p-4 bg-amber-50/70 border border-amber-200 rounded-xl text-right text-xs text-amber-900 space-y-1.5",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
									className: "font-bold flex items-center gap-1.5",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(KeyRound, { className: "h-4 w-4 text-[#8C2A3E]" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "تأكيد الحساب عبر البريد الإلكتروني" })]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
									className: "text-[11px] text-[#5A412F] leading-relaxed",
									children: [
										"إذا وصلتكِ رسالة من Supabase تحتوي على ",
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "رابط تأكيد (Confirm link)" }),
										"، يمكنكِ الضغط عليه في بريدكِ وسيتم تفعيل حسابكِ مباشرة."
									]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "text-[11px] text-[#5A412F] leading-relaxed",
									children: "أو إذا كان بريدكِ يحتوي على رمز رقمي (OTP)، أدخليه في الخانات أدناه:"
								})
							]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								...
								children: isLoading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, { className: "h-4 w-4 animate-spin text-white" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "تأكيد الرمز البريدي وإنشاء الحساب" })
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								type: "button",
								disabled: isLoading,
								onClick: async () => {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheck, { className: "h-3.5 w-3.5 text-emerald-600" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "تأكيد فوري للحساب ومتابعة التسوق" })]
							})]
						})
					]
				}),
...
var $$splitComponentImporter$12 = () => import("./routes-A9q0qk0A.mjs");
...
var $$splitComponentImporter$11 = () => import("./abayas-Ep0xjG9k.mjs");
...
var $$splitComponentImporter$10 = () => import("./accessories-PMoHXs0I.mjs");
...
var $$splitComponentImporter$9 = () => import("./admin-Cplx6PMf.mjs");
...
var $$splitComponentImporter$8 = () => import("./articles-aJ3XRDv1.mjs");
...
var $$splitComponentImporter$7 = () => import("./dresses-BhGq4v8g.mjs");
...
var $$splitComponentImporter$6 = () => import("./hijab-robe-kIeKB_gE.mjs");
...
var $$splitComponentImporter$5 = () => import("./hijab-supplies-Dp2RAC9s.mjs");
...
var $$splitComponentImporter$4 = () => import("./isdalat-W7Q8e5x1.mjs");
...
var $$splitComponentImporter$3 = () => import("./khimar-DJqXyYTH.mjs");
...
var $$splitComponentImporter$2 = () => import("./sales-LCoh41pn.mjs");
...
var $$splitComponentImporter$1 = () => import("./shoes-BE1Yj9X6.mjs");
...
var $$splitComponentImporter = () => import("./shop-BkYCsDhG.mjs");
